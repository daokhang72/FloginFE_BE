...
\section*{CHƯƠNG 2: UNIT TESTING VÀ TEST-DRIVEN DEVELOPMENT (TDD)}
\addcontentsline{toc}{section}{CHƯƠNG 2: UNIT TESTING VÀ TEST-DRIVEN DEVELOPMENT (TDD)}
...
\begin{figure}[h]
\centering
\fbox{\includegraphics[width=0.85\textwidth]{images/login_validation_frontend.png}}
...
\begin{figure}[h]
\centering
\fbox{\includegraphics[width=0.85\textwidth]{images/auth_service_backend.png}}
...
\begin{figure}[h]
\centering
\fbox{\includegraphics[width=0.85\textwidth]{images/product_validation_frontend.png}}
...
\begin{figure}[h]
\centering
\fbox{\includegraphics[width=0.85\textwidth]{images/product_service_backend.png}}
...
\begin{figure}[h]
\centering
\fbox{\includegraphics[width=0.85\textwidth]{images/frontend_coverage.png}}
...
\begin{figure}[h]
\centering
\fbox{\includegraphics[width=0.85\textwidth]{images/backend_coverage.png}}
