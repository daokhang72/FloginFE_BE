...
% Turn off page numbering for cover and TOC
...
{\footnotesize TP. HỒ CHÍ MINH, NGÀY 2 THÁNG 12 NĂM 2025}
\end{center}
\end{titlepage}
...
% Start page numbering from 1 with arabic numerals
...
\vspace{1cm}
\begin{flushright}
\textit{TP. Hồ Chí Minh, ngày 2 tháng 12 năm 2025}\\
\end{flushright}
...
\input{../bao_cao_test_case_design/BaoCao_TestCaseDesign_Content.tex}
...
\input{../bao_cao_integration_testing/BaoCao_IntegrationTesting_Content.tex}
