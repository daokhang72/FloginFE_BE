...
\subsection{Câu 5.1: Login - E2E Automation Testing}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth, scale=0.9]{../bao_cao_automation_testing/images/login_e2e_results.png}
...
\subsection{Câu 5.2: Product - E2E Automation Testing} 
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth, scale=0.9]{../bao_cao_automation_testing/images/product_e2e_results.png}
